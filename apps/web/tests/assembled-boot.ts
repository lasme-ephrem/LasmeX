...
import type { WebBootEntry } from 'lasmex-client-modules/client'
...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  { id: 'lasmex-typert-registry', bundlePath: 'packages/typert/registry/lib/client.js', url: '/plugins/typert-registry.js', rev: 'fx', inject: [], immediately: true },
  { id: 'lasmex-client-connection', bundlePath: 'packages/client/connection/lib/client.js', url: '/plugins/connection.js', rev: 'fx', inject: [], immediately: true },
  { id: 'lasmex-api-gateway', bundlePath: 'packages/api/gateway/lib/client.js', url: '/plugins/api-gateway.js', rev: 'fx', inject: ['lasmex-typert-registry', 'lasmex-client-connection'], immediately: true },
  { id: 'lasmex-api-remotes', bundlePath: 'packages/api/remotes/lib/client.js', url: '/plugins/api-remotes.js', rev: 'fx', inject: ['lasmex-api-gateway'], immediately: true },
  ...
  { id: 'lasmex-client-ui-settings', bundlePath: 'packages/client/ui-settings/lib/client.js', url: '/plugins/ui-settings.js', rev: 'fx', inject: ['lasmex-client-connection', 'lasmex-client-runtime', 'lasmex-api-remotes'], immediately: true },
  { id: 'lasmex-client-runtime', bundlePath: 'packages/client/runtime/lib/client.js', url: '/plugins/runtime.js', rev: 'fx', inject: ['lasmex-client-connection', 'lasmex-typert-registry', 'lasmex-api-gateway'], immediately: true },
  { id: 'lasmex-client-ui-theme', bundlePath: 'packages/client/ui-theme/lib/client.js', url: '/plugins/ui-theme.js', rev: 'fx', inject: ['lasmex-client-connection', 'lasmex-client-runtime', 'lasmex-client-locale', 'lasmex-client-ui-settings', 'lasmex-api-remotes'], immediately: true },
  { id: 'lasmex-client-locale', bundlePath: 'packages/client/locale/lib/client.js', url: '/plugins/locale.js', rev: 'fx', inject: ['lasmex-client-connection', 'lasmex-client-runtime', 'lasmex-client-ui-settings', 'lasmex-api-remotes'], immediately: true },
  { id: 'lasmex-client-ui-layout', bundlePath: 'packages/client/ui-layout/lib/client.js', url: '/plugins/ui-layout.js', rev: 'fx', inject: ['lasmex-client-runtime'] },
  { id: 'lasmex-client-ui-sidebar', bundlePath: 'packages/client/ui-sidebar/lib/client.js', url: '/plugins/ui-sidebar.js', rev: 'fx', inject: ['lasmex-client-ui-layout'] },
  { id: 'lasmex-client-ui-conversation', bundlePath: 'packages/client/ui-conversation/lib/client.js', url: '/plugins/ui-conversation.js', rev: 'fx', inject: ['lasmex-client-ui-layout'] },
  { id: 'lasmex-client-ui-tool', bundlePath: 'packages/client/ui-tool/lib/client.js', url: '/plugins/ui-tool.js', rev: 'fx', inject: ['lasmex-client-runtime', 'lasmex-client-locale', 'lasmex-client-ui-conversation'] },
  { id: 'lasmex-client-ui-workflow-run', bundlePath: 'packages/client/ui-workflow-run/lib/client.js', url: '/plugins/ui-workflow-run.js', rev: 'fx', inject: ['lasmex-client-locale', 'lasmex-client-runtime', 'lasmex-client-ui-conversation'] },
  {
    id: 'lasmex-client-ui-workspace',
    bundlePath: 'packages/client/ui-workspace/lib/client.js',
    url: '/plugins/ui-workspace.js',
    rev: 'fx',
    inject: [
      'lasmex-client-runtime',
      'lasmex-client-ui-conversation',
      'lasmex-client-ui-sidebar',
    ],
  },
  { id: 'lasmex-session-log-export', bundlePath: 'packages/session-query/session-log-export/lib/client.js', url: '/plugins/session-log-download.js', rev: 'fx', inject: ['lasmex-client-ui-commands', 'lasmex-client-ui-conversation'] },
  { id: 'lasmex-client-ui-trajectory', bundlePath: 'packages/client/ui-trajectory/lib/client.js', url: '/plugins/ui-trajectory.js', rev: 'fx', inject: ['lasmex-client-ui-conversation'] },
]
