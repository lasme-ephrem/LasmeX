...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"lasmex-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"lasmex-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"lasmex-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"lasmex-skill-filesystem"}\n',
