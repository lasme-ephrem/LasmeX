...
This overlay opts one `lasmex web` process into Schedule reminders without changing the shipped default Web composition:

```sh
lasmex web --patch examples/web-schedule/cordis.yml
```
