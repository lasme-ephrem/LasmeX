/**
 * Package-owned invariant companion for `lasmex-client-ui-attachment`.
 * @module lasmex-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-attachment'
