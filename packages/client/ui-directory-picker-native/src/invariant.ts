/**
 * Package-owned invariant companion for `lasmex-client-ui-directory-picker-native`.
 * @module lasmex-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-directory-picker-native'
