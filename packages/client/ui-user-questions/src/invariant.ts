/**
 * Package-owned invariant companion for `lasmex-client-ui-user-questions`.
 * @module lasmex-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-user-questions'
