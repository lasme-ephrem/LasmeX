/**
 * Package-owned invariant companion for `lasmex-client-ui-input-trigger`.
 * @module lasmex-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-input-trigger'
