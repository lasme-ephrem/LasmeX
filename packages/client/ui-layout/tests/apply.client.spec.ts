...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from 'lasmex-client-ui-theme/client'
import { apply, inject, LayoutController } from 'lasmex-client-ui-layout/client'
import { apply as nodeApply } from 'lasmex-client-ui-layout'
import * as invariant from 'lasmex-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('lasmex-client-ui-layout', expect.any(Function))
