...
// (`/types`, zero imports), never the package root: the root's lasmex-agent →
// lasmex-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from 'lasmex-session-projection/types'
