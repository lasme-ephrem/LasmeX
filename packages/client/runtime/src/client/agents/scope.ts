 ...
 * Agent's identity. The mechanism mirrors the host `lasmex-scope` architecture
...
import type { TypertClientRemote, TypertRemoteScopeApi } from 'lasmex-typert-protocol'
...
const kScope = Symbol('lasmex.client.scope')
