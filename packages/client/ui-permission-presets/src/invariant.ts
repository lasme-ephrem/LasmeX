/**
 * Package-owned invariant companion for `lasmex-client-ui-permission-presets`.
 * @module lasmex-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-permission-presets'
