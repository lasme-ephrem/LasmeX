...
import type { SessionProviderComponent, TranslateNS } from 'lasmex-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from 'lasmex-client-ui-conversation/src/client/contract/slots.ts'
