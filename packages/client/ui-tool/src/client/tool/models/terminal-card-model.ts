...
import type { TerminalBlockLabels, TerminalBlockProps } from 'lasmex-client-ui-primitives'
 ...
 * `ToolResultNode.call`/`callView` in lasmex-client-runtime), leaving a terminal
