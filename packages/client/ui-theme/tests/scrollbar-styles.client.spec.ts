...
const INDIRECTION_PREFIX = '--lasmex-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--lasmex-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--lasmex-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css width variable', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--lasmex-scrollbar-width)`); a rename in scrollbar.css without
