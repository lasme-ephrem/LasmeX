...
export const fr = {
  'chip.label': 'Plan',
  'chip.on.aria': 'Mode plan activé, appuyez pour le désactiver',
  'chip.on.title': 'Mode plan activé — cliquez pour le désactiver (/plan off)',
  'chip.off.aria': 'Mode plan désactivé, appuyez pour l’activer',
  'chip.off.title': 'Mode plan désactivé — cliquez pour l’activer (/plan)',
