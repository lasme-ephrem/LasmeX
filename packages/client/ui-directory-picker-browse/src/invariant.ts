/**
 * Package-owned invariant companion for `lasmex-client-ui-directory-picker-browse`.
 * @module lasmex-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-directory-picker-browse'
