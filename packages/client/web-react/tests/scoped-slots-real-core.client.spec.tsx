...
import { SlotCore, type PropsRenderSlots, type SlotRendererHost } from 'lasmex-client-ui-slots'
import { createSlotRenderer, StaleAuthorizationError } from 'lasmex-client-web-react'
