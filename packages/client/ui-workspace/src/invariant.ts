/**
 * Package-owned invariant companion for `lasmex-client-ui-workspace`.
 * @module lasmex-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-workspace'
