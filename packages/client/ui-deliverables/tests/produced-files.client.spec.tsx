...
import { apply as applyLocale, inject as localeInject } from 'lasmex-client-locale/client'
import type { ChatFileMentions, TurnTailOwnerProps } from 'lasmex-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from 'lasmex-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['lasmex-client-ui-deliverables'])
