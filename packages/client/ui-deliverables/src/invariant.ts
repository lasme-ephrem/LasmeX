/**
 * Package-owned invariant companion for `lasmex-client-ui-deliverables`.
 * @module lasmex-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-deliverables'
