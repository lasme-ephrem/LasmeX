/**
 * Package-owned invariant companion for `lasmex-client-ui-settings-plugins`.
 * @module lasmex-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-settings-plugins'
