/**
 * Package-owned invariant companion for `lasmex-client-ui-settings-general`.
 * @module lasmex-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-settings-general'
