/**
 * Package-owned invariant companion for `lasmex-client-ui-message-feedback`.
 * @module lasmex-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-message-feedback'
