/**
 * Package-owned invariant companion for `lasmex-client-ui-settings-models`.
 * @module lasmex-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-settings-models'
