/**
 * Package-owned invariant companion for `lasmex-client-ui-model-selection`.
 * @module lasmex-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-model-selection'
