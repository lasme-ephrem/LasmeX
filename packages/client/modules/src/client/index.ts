 ...
 * @module lasmex-client-modules/client
 */
import type { Context } from '@deepseek-ai/cordis'
import type { LasmexWindow } from './manifest.ts'
...
export type {
  ...
  ClientModuleSystemOptions, ClientPluginHandoff, LasmexWindow, WebBootEntry, WebBootGraph,
} from './manifest.ts'
...
export function apply(ctx: Context): void {
  const modules = (globalThis as LasmexWindow).__DSH_MODULES__
