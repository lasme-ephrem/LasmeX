...
import type { ClientSessionContext, CommandClaim, PickOutcome, SubmitOutcome } from 'lasmex-client-ui-input-trigger/client'
...
import type { ConversationSnapshot } from 'lasmex-client-runtime/client'
