/**
 * Package-owned invariant companion for `lasmex-client-ui-conversation`.
 * @module lasmex-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-conversation'
