...
import type { WorkspaceId } from 'lasmex-client-runtime/client'
...
export function ConversationRoot({
  ...
  // Publishes the seat's live height as --lasmex-composer-height on the scroll
  ...
  const seatResizeRef = useCallback((seat: HTMLDivElement | null): void => {
    ...
    seatObserver.current = new ResizeObserver(() => {
      scroller.style.setProperty('--lasmex-composer-height', `${seat.offsetHeight}px`)
    })
