/**
 * Package-owned invariant companion for `lasmex-client-ui-agent-preset`.
 * @module lasmex-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-agent-preset'
