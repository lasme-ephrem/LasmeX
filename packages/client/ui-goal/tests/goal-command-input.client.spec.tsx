...
import { ConversationNodeAssembler } from 'lasmex-client-runtime/client'
import { makeTranslate } from 'lasmex-client-test-runtime'
import { zh as commonZh } from 'lasmex-client-locale/src/locales/zh.ts'
import type { SessionEvent } from 'lasmex-session/types'
import { commandDefinition } from 'lasmex-client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from 'lasmex-client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
