/**
 * Package-owned invariant companion for `lasmex-client-ui-primitives`.
 * @module lasmex-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-primitives'
