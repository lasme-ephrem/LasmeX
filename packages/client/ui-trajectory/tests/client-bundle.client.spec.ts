 ...
 * not built (`pnpm --filter lasmex-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = 'lasmex-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['lasmex-client-runtime/client', await import('lasmex-client-runtime/client')],
      ['lasmex-client-ui-primitives', await import('lasmex-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('lasmex-client-locale/client')
