/**
 * Package-owned invariant companion for `lasmex-client-ui-trajectory`.
 * @module lasmex-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = 'lasmex-client-ui-trajectory'
