...
import { apply as nodeApply } from 'lasmex-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from 'lasmex-client-locale/client'
import * as LocaleInvariant from 'lasmex-client-locale/invariant'
