/**
 * Package-owned invariant companion for `lasmex-web-search-deepseek`.
 * @module lasmex-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = 'lasmex-web-search-deepseek'
