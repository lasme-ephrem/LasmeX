 ...
 * @module lasmex-web-search-deepseek/provider
 */
...
import type {} from 'lasmex-session'
import type {
  AnthropicError,
  AnthropicResponse,
  ContentBlock,
 ...
 * (`https://api.deepseek.com`) `lasmex-llm-deepseek` uses, so this
...
const USER_AGENT = 'lasmex/0.1.0 (+https://github.com/lasme-ephrem/LasmeX)'
