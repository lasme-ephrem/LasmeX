 ...
 * (`lasmex-spill-local` backend + `lasmex-spill-policy`), exercised through
...
import LocalSpillStore from 'lasmex-spill-local'
...
beforeEach(async () => {
  ...
  spillRoot = mkdtempSync(join(tmpdir(), 'lasmex-spill-web-'))
