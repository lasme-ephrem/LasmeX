 ...
 * `lasmex-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module lasmex-web-fetch-http/provider
 */

import { WebError } from 'lasmex-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from 'lasmex-web'
