/**
 * `lasmex-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `lasmex-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `lasmex-web`.
 *
 * @module lasmex-web-search-exa
 */

import type { Context } from '@deepseek-ai/cordis'
import { launchEnvironmentOf } from 'lasmex-launch-environment'
import z from '@deepseek-ai/schemastery'
import type {} from 'lasmex-web'
import {
  ExaSearchProvider,
