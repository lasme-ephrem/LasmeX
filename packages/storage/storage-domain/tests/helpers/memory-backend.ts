 ...
 *
 * Fidelity to the backend contract (`lasmex-storage` `src/backend.ts`): version
...
import { StorageError } from 'lasmex-storage'
import type { KvFacet, KvUnit, KvUnitDescriptor, StorageBackend } from 'lasmex-storage'
