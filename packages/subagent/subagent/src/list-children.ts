...
import type { SessionProjectionRegistry } from 'lasmex-session-projection'
import type { SessionProjectionCache } from 'lasmex-session-projection-cache'
...
async function prepareListing(
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load lasmex-session)',
