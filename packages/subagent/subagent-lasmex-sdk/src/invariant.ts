/**
 * Package-owned invariant companion for `lasmex-subagent-lasmex-sdk`.
 * @module lasmex-subagent-lasmex-sdk/invariant
 */
...
const PACKAGE_NAME = 'lasmex-subagent-lasmex-sdk'

/** Cordis companion plugin name. */
export const name = 'subagent-lasmex-sdk-invariant'
