 ...
 * @module lasmex-subagent-in-process-driver/structured
 */

import type { Context } from '@deepseek-ai/cordis'
import type { ToolSchema } from 'lasmex-llm'
import type { ToolExecution, ToolRunContext } from 'lasmex-tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from 'lasmex-tools'
 ...
 *   `assertObjectJsonSchema` in lasmex-tools).
