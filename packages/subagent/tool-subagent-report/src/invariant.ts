/**
 * Package-owned invariant companion for `lasmex-tool-subagent-report`.
 * @module lasmex-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = 'lasmex-tool-subagent-report'
