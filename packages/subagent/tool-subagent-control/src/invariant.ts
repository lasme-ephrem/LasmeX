/**
 * Package-owned invariant companion for `lasmex-tool-subagent-control`.
 * @module lasmex-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = 'lasmex-tool-subagent-control'
