/**
 * Package-owned invariant companion for `lasmex-repeat-tool-reminder`.
 * @module lasmex-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = 'lasmex-repeat-tool-reminder'
