/**
 * Unit + real-load-path coverage for lasmex-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from 'lasmex-llm'
import SystemPrompt from 'lasmex-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from 'lasmex-tools'
import * as timeoutPolicy from 'lasmex-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from 'lasmex-tool-call-timeout-policy'
...
describe('lasmex-tool-call-timeout-policy real-load-path guard', () => {
