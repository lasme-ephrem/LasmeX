/**
 * Package-owned invariant companion for `lasmex-tool-call-timeout-policy`.
 * @module lasmex-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = 'lasmex-tool-call-timeout-policy'
