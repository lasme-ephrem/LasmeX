 ...
 *
 * @module lasmex-compaction-tool-result-pruner
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { freezeMessage } from 'lasmex-llm'
import type { ContentBlock } from 'lasmex-llm'
import type { Session, SessionEvent, ToolResultMessage } from 'lasmex-session'
// Type-only: the `compaction/*` SessionEventMap merges (the shadow-price event).
import type {} from 'lasmex-compaction'
