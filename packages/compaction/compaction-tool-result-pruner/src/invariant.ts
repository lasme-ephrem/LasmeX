/**
 * Package-owned invariant companion for `lasmex-compaction-tool-result-pruner`.
 * @module lasmex-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = 'lasmex-compaction-tool-result-pruner'
