 ...
 *
 * The seam itself lives in `lasmex-compaction`, which re-exports these
 ...
 * `lasmex-commands/brand` shape.
 *
 * @module lasmex-compaction/checkpoint
 */

import type { MessageSource } from 'lasmex-llm/message'
