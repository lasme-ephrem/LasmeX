 ...
 *
 * @module lasmex-compaction-basic/summarizer
 */

import type { Context } from '@deepseek-ai/cordis'
import { contentHasImage, createUserMessage, BlockAssembler, LlmError } from 'lasmex-llm'
import type {
...
export async function summarizeWithLlm(
  ...
  const messages: Message[] = [
    ...
    createUserMessage({
      ...
      source: { kind: 'plugin', plugin: 'lasmex-compaction-basic' },
    }),
  ]
