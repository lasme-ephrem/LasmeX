 ...
 *
 * @module lasmex-compaction-basic
 */

import { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { CompactionEngine, ManualCompactionError } from 'lasmex-compaction'
import type { CompactionResult, CompactionTrigger } from 'lasmex-compaction'
import type { TokenMeter } from 'lasmex-token-meter'
import type { Session } from 'lasmex-session'
import { CONTEXT_WINDOW_EXCEEDED_CODE, assertNever } from 'lasmex-llm'
import type { LlmCallConfig } from 'lasmex-llm'
import type { Agent, PreStepDecision } from 'lasmex-agent'
import type { CommandId } from 'lasmex-commands/brand'
// Type-only: makes the optional sibling service available to `ctx.get()`.
import type {} from 'lasmex-compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
