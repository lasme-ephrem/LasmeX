 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in lasmex-llm (tool-call
 * correlation), the shared agent/session `SessionId` in lasmex-session, and
 * `JobId` in lasmex-jobs. Branding is for ids that cross package boundaries and
