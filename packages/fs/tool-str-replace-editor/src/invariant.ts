/**
 * Package-owned invariant companion for `lasmex-tool-str-replace-editor`.
 * @module lasmex-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = 'lasmex-tool-str-replace-editor'
