 ...
 * streams large files, and rejects binary data; line windows belong to `lasmex-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module lasmex-fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from 'lasmex-fs'
