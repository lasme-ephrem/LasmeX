/** Shared top-level-call post-policy selection for search result spill. @module lasmex-tool-fs-search/direct-call */

import type { Context } from '@deepseek-ai/cordis'
import type { JsonValue, PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from 'lasmex-tools'
