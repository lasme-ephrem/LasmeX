...
export const en = {
  ...
  'panel.operationFailed': 'Operation failed',
...
/** Messages français de l’interface Cordis. */
export const fr = {
  ...
  'row.inspect': 'Afficher les détails',
  'purpose.missing': '(objectif non renseigné)',
  'status.idle': 'Prêt',
  'status.awaitingApproval': 'En attente d’autorisation',
  'status.failed': 'Échec de l’exécution',
  'status.clientPending': 'Client prêt à être activé',
  'status.running': 'En cours',
  'status.removed': 'Retiré',
  'status.superseded': 'Nouvelle exécution disponible',
  'run.removed': 'Ce paquet n’existe plus',
  'run.superseded': 'Une fiche d’exécution plus récente est disponible ci-dessous',
  'panel.hint': 'Les commandes d’exécution se trouvent dans le panneau Cordis au-dessus des paramètres',
  'panel.plugins.aria': 'Plugins Cordis',
  'panel.approvals.aria': 'Autorisations Cordis',
  'panel.trigger': 'Plugin Cordis',
  'panel.runningCount': '{count} en cours',
  'panel.title': 'Plugins Cordis',
  'panel.empty': 'Aucun plugin défini',
  'panel.loading': 'Lecture…',
  'panel.readFailed': 'Échec de la lecture de l’inventaire des plugins : {message}',
  'panel.operationFailed': 'Échec de l’opération',
  ...
  'action.approvePlugin': 'Autoriser les prochaines versions de ce plugin',
  ...
  'body.source': 'Code source du plugin',
  'body.hostCode': 'Hôte',
  'body.clientCode': 'Client',
