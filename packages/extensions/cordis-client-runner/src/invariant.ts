/**
 * Package-owned invariant companion for `lasmex-cordis-client-runner`.
 * @module lasmex-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = 'lasmex-cordis-client-runner'
