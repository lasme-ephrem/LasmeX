 ...
 * @module lasmex-cordis-host-runner/guard
 */

import { Context } from '@deepseek-ai/cordis'
import type { Plugin } from '@deepseek-ai/cordis'
import { scopeOf } from 'lasmex-scope'
import { assertSupportedJsonSchema, defineTool } from 'lasmex-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`lasmex-cordis-client-runner`, whose CTX_VERBS names this one its
