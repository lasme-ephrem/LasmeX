/**
 * Package-owned invariant companion for `lasmex-jobs-local`.
 * @module lasmex-jobs-local/invariant
 */
...
const PACKAGE_NAME = 'lasmex-jobs-local'
...
/**
 * No runtime invariant: `lasmex-jobs/invariant` owns per-snapshot identity, status,
