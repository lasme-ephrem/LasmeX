...
import { TerminalSessionId } from 'lasmex-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from 'lasmex-terminal'
import type {} from 'lasmex-jobs'
import { defineTool } from 'lasmex-tools'
import type { ToolDefinition } from 'lasmex-tools'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require lasmex-jobs and lasmex-tool-jobs')
