 ...
 * mapping; shared execution and parsing live in `lasmex-hook-protocol`.
 ...
 * @module lasmex-hooks-claude-code
 */
...
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from 'lasmex-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
