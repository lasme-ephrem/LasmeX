 ...
 *
 * @module lasmex-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from 'lasmex-shell'
 ...
 * rendering story, owned by `lasmex-shell` so `lasmex-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from 'lasmex-shell'
