 ...
 * `lasmex-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module lasmex-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from 'lasmex-shell'
import type { SandboxMode } from 'lasmex-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from 'lasmex-sandbox'

/* jscpd:ignore-start -- deliberate twin of lasmex-tool-bash/render.ts (Agent Note). */
