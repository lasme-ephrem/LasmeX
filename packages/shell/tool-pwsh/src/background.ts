 ...
 * twin of `lasmex-tool-bash`'s background adaptation.
 *
 * @module lasmex-tool-pwsh/background
 */

import type { ShellProcess } from 'lasmex-shell'

/* jscpd:ignore-start -- deliberate twin of lasmex-tool-bash/background.ts (Agent Note). */
