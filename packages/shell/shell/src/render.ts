/**
 * Shared rendering helpers for the shell tools (`lasmex-tool-bash`,
 * `lasmex-tool-pwsh`): the exit-status marker contract the tools' renderers
 * emit and the presentation layer parses back.
 * @module lasmex-shell/render
 */
