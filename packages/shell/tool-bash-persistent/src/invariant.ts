/**
 * Package-owned invariant companion for `lasmex-tool-bash-persistent`.
 * @module lasmex-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = 'lasmex-tool-bash-persistent'
