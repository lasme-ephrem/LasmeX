/**
 * Package-owned invariant companion for `lasmex-sandbox-windows-acl`.
 * @module lasmex-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = 'lasmex-sandbox-windows-acl'
