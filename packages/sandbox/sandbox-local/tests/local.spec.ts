...
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from 'lasmex-sandbox'
import type { SandboxPolicy } from 'lasmex-sandbox'
import {
  LocalSandboxProvider,
} from 'lasmex-sandbox-local'
import type { Config } from 'lasmex-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in lasmex-sandbox-windows-acl/tests/provider-chain.spec.ts
