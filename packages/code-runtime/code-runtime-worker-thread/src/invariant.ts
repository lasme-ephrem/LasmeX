/**
 * Package-owned invariant companion for `lasmex-code-runtime-worker-thread`.
 * @module lasmex-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = 'lasmex-code-runtime-worker-thread'
