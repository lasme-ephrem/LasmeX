 ...
 * @module lasmex-code-runtime-worker-thread/src/worker
 */
...
if (!parentPort) throw new Error('lasmex-code-runtime-worker-thread: worker entry loaded outside a worker thread')
