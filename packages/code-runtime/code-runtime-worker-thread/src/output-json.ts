/** JSON string-prefix accounting for the outer-output ledger. @module lasmex-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from 'lasmex-code-runtime'
