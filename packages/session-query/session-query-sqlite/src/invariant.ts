/**
 * Package-owned invariant companion for `lasmex-session-query-sqlite`.
 * @module lasmex-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = 'lasmex-session-query-sqlite'
