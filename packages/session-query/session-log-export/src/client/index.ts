...
import type {} from 'lasmex-client-ui-commands/client'
...
import { en, fr, NS, zh, type SessionLogDownloadKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { fr, en, zh }), 'session-log-download: browser dictionaries')
