...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from 'lasmex-session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from 'lasmex-session'
