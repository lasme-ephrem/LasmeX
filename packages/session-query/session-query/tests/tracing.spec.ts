import { createUserMessage, createMessage } from 'lasmex-llm'
import { describe, expect, it } from 'vitest'
import { Context } from '@deepseek-ai/cordis'
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from 'lasmex-session'
import type { Session, SessionEvent, SessionHeader, SessionId as SessionIdType } from 'lasmex-session'
import SessionPersistence from 'lasmex-session-persistence'
import { type SessionQueryErrorCode } from 'lasmex-session-query'
