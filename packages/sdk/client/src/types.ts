 ...
 *
 * @module lasmex-sdk-client/types
 */
...
export interface HarnessClientOptions {
  /** The runtime executable (the `lasmex-jsonrpc-agent` bin, a packaged exe, or `node`). */
  command: string
   ...
   * credential policy (see `scrubbedParentEnv` in `lasmex-subprocess`
...
/** Options for the high-level {@link LasmeX} wrapper. */
export interface LasmeXOptions {
