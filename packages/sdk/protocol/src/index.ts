/**
 * Shared wire protocol for the LasmeX SDK runtime: the
 ...
 * (`lasmex-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`lasmex-sdk-client`, the Python SDK) drive it.
 *
 * @module lasmex-sdk-protocol
 */
