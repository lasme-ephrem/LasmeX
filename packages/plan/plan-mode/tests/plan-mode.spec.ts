...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from 'lasmex-tools'
import { Session, SessionId, type UserMessage } from 'lasmex-session'
import AgentRegistry, { agentEvents, type Agent } from 'lasmex-agent'
...
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from 'lasmex-code-runtime'
...
/**
 * Drives the REAL plugin: mounts `lasmex-plan-mode` beside real `SystemPrompt` and
