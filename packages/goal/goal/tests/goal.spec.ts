...
import { createUserMessage, HarnessError } from 'lasmex-llm'
import SessionStore, { Session, SessionId, type UserMessage } from 'lasmex-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
...
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from 'lasmex-goal'
...
function stubAgent(rawId: string, seed?: readonly import('lasmex-session').SessionEvent[]): StubAgent {
