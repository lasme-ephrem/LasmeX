 ...
 * @module lasmex-session-title-llm
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { createUserMessage, BlockAssembler, deepFreeze } from 'lasmex-llm'
import type { FinishReason, GenerateOptions, Message } from 'lasmex-llm'
import { deadline, MAX_TIMER_DELAY_MS } from 'lasmex-timeout'
import {
  normalizeSessionTitle,
  SessionTitleProviderId,
} from 'lasmex-session-title'
import type {
...
export async function generateSessionTitleWithLlm(
  ...
  const messages: Message[] = [createUserMessage({
    ...
    source: { kind: 'plugin', plugin: 'lasmex-session-title-llm' },
  })]
