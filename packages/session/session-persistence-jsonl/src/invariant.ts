/**
 * Package-owned invariant companion for `lasmex-session-persistence-jsonl`.
 * @module lasmex-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = 'lasmex-session-persistence-jsonl'
