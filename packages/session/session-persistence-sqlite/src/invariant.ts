/**
 * Package-owned invariant companion for `lasmex-session-persistence-sqlite`.
 * @module lasmex-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = 'lasmex-session-persistence-sqlite'
