/**
 * Package-owned invariant companion for `lasmex-session-persistence`.
 * @module lasmex-session-persistence/invariant
 */
...
const PACKAGE_NAME = 'lasmex-session-persistence'
