/**
 * Package-owned invariant companion for `lasmex-session-checkpoint-policy`.
 * @module lasmex-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = 'lasmex-session-checkpoint-policy'
