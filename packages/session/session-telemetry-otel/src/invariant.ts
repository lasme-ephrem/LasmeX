/**
 * Package-owned invariant companion for `lasmex-session-telemetry-otel`.
 * @module lasmex-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = 'lasmex-session-telemetry-otel'
