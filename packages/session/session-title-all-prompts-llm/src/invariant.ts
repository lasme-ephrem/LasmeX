/**
 * Package-owned invariant companion for `lasmex-session-title-all-prompts-llm`.
 * @module lasmex-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = 'lasmex-session-title-all-prompts-llm'
