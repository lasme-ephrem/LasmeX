/**
 * Package-owned invariant companion for `lasmex-session-projection-cache`.
 * @module lasmex-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = 'lasmex-session-projection-cache'
