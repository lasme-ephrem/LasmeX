/**
 * lasmex-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `lasmex-brand`; this module
 ...
 * loading the host plugin's Context merges — the `lasmex-llm/brand` shape.
 *
 * @module lasmex-commands/brand
 */
