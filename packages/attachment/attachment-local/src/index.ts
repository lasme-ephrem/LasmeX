/** Local durable attachment backend rooted below `LASMEX_HOME`. @module lasmex-attachment-local */
...
export class LocalAttachmentStore extends AttachmentStore {
  ...
  constructor(ctx: Context, config: Config) {
    super(ctx)
    this.root = resolve(join(resolveLasmexHome(config.lasmexHome), 'attachments', 'v1'))
