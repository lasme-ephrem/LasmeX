 ...
 *
 * @module lasmex-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$LASMEX_HOME`.
 * Discovery (`$LASMEX_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.lasmex/AGENTS.md' || displayPath === '$LASMEX_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
