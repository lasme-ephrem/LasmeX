 ...
 *
 * @module lasmex-agent-instructions/config
 */
...
export function resolveDiscoveryConfig(
  config: Pick<Config, 'lasmexHome' | 'projectRootMarkers' | 'instructionFileCandidates' | 'localInstructionFileCandidates'>,
): ResolvedDiscoveryConfig {
  return {
    lasmexHome: resolveLasmexHome(config.lasmexHome),
