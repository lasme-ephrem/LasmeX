/** Package-owned durable retry-event invariants. @module lasmex-llm-retry/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { Session, SessionEvent } from 'lasmex-session'
import type { LlmFailure } from 'lasmex-llm'
...
const PACKAGE_NAME = 'lasmex-llm-retry'
