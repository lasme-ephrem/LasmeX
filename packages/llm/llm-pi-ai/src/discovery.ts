 ...
 *
 * @module lasmex-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from 'lasmex-llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from 'lasmex-llm'
import { attributionHeaders } from 'lasmex-llm'
 ...
 * on the length the server claims — the same two-stage shape `lasmex-web-fetch`
