 ...
 * ([`lasmex-code-runtime-worker-thread`](../../code-runtime/code-runtime-worker/README.md)).
 ...
 * @module lasmex-agent-tool-presentation
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import type { ToolPresentationMode } from 'lasmex-tools'
...
export function apply(ctx: Context, config: Config): void {
  ...
  // what `lasmex-agent-presets` reports as an unusable row, naming this id.
