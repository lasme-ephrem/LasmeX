/** Package-owned scoped-dispatch invariants. @module lasmex-scope/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from 'lasmex-invariants'
import { carrierKeyOf, isScopeCarrier } from 'lasmex-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = 'lasmex-scope'
