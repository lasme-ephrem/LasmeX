 ...
 * @module lasmex-agent-loop/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import { isAgentLoopRequest, type GenerateOptions } from 'lasmex-llm'
import type { InvariantFailure, InvariantInstaller } from 'lasmex-invariants'
import { foldRequestHeader } from 'lasmex-session'

const PACKAGE_NAME = 'lasmex-agent-loop'
