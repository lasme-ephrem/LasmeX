...
| Package | Role |
|---|---|
| `lasmex-spill` (this) | Service Definition: abstract service + vocabulary types |
| `lasmex-spill-local` | Service Provider: private session-scoped files on the host filesystem |
| `lasmex-spill-policy` | Consumer: the tool-result policy that spills oversized final results |
