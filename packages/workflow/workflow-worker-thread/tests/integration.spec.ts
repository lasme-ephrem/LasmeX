...
import * as spawn from 'lasmex-subagent-spawn-in-process'
import { STRUCTURED_OUTPUT_TOOL } from 'lasmex-subagent-in-process-driver'
...
describe('lasmex-workflow-worker-thread over the real in-process stack', () => {
