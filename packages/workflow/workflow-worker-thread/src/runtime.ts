 ...
 * @module lasmex-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from 'lasmex-llm'
import { SessionId } from 'lasmex-session'
import { assertObjectJsonSchema, JsonSchemaError } from 'lasmex-tools'
import type { ObjectJsonSchema } from 'lasmex-tools'
import { isFatalWorkflowError, WorkflowError } from 'lasmex-workflow'
import type {
