 ...
 * (`lasmex-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module lasmex-tool-workflow
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { defineTool } from 'lasmex-tools'
import type { ToolCallView, ToolResultView } from 'lasmex-tools'
import type { ContentBlock } from 'lasmex-llm'
import type { JsonValue, Session, SessionEventMap } from 'lasmex-session'
import type {
