 ...
 * @module lasmex-agent-presets/discovery
 */
...
import { expandHomePath } from 'lasmex-home-paths'
 ...
 *
 * This package owns the writable root the way `lasmex-skill-filesystem` owns
 * `<lasmexHome>/skills`. An app must assemble the SHIPPED root, whose path only
