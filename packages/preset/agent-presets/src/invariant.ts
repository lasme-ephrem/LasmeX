/**
 * Package-owned invariant companion for `lasmex-agent-presets`.
 * @module lasmex-agent-presets/invariant
 */
...
// joins, and the `agent` field `lasmex-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from 'lasmex-agent-presets'

const PACKAGE_NAME = 'lasmex-agent-presets'
