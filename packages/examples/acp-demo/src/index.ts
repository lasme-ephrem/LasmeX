 ...
 * ({@link lasmex-agent-spine-demo}), JSONL session persistence, and
 * the {@link lasmex-acp} bridge. The app owns those plugins through one
 ...
 * @module lasmex-acp-demo
 */

import type { Context } from '@deepseek-ai/cordis'
import { join } from 'node:path'
import z from '@deepseek-ai/schemastery'
import * as acp from 'lasmex-acp'
...
} from 'lasmex-session-persistence-jsonl'
import * as sessionCheckpointPolicy from 'lasmex-session-checkpoint-policy'
...
export const Config: z<Config> = z.object({
  ...
  // order" (the owning lasmex-system-prompt schema does the same), while
