 ...
 * @module lasmex-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: 'lasmex-host-directory-picker-native',
  browse: 'lasmex-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: 'lasmex-client-ui-directory-picker-native',
  browse: 'lasmex-client-ui-directory-picker-browse',
}
