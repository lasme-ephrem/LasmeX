...
import HttpServer from 'lasmex-host-webserver'
import type { DirectoryPicker } from 'lasmex-host-directory-picker'
import BrowseDirectoryPicker from 'lasmex-host-directory-picker-browse'
import NativeDirectoryPicker from 'lasmex-host-directory-picker-native'
...
const AUTO = 'lasmex-host-directory-picker-auto'
const NATIVE = 'lasmex-host-directory-picker-native'
const BROWSE = 'lasmex-host-directory-picker-browse'
const NATIVE_SURFACE = 'lasmex-client-ui-directory-picker-native'
const BROWSE_SURFACE = 'lasmex-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['lasmex-host-webserver', HttpServer],
