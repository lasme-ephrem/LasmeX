/** Package-owned invariant companion for the directory-picker seam. @module lasmex-host-directory-picker/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from 'lasmex-invariants'

const PACKAGE_NAME = 'lasmex-host-directory-picker'
