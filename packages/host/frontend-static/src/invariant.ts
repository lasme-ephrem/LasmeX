/**
 * Package-owned invariant companion for `lasmex-host-frontend-static`.
 * @module lasmex-host-frontend-static/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from 'lasmex-invariants'

const PACKAGE_NAME = 'lasmex-host-frontend-static'
