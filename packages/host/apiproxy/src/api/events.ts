...
import type { AskUserQuestionItem } from 'lasmex-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from 'lasmex-user-approval/types'
import type { Message } from 'lasmex-llm/types'
import type { MessageId } from 'lasmex-llm/brand'
import type { CallId } from 'lasmex-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from 'lasmex-session/types'
import type { ToolCallView, ToolResultView } from 'lasmex-tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// lasmex-tools remains its owner.
export type { ToolCallView, ToolResultView } from 'lasmex-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `lasmex-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
