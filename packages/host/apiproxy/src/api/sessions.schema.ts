...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from 'lasmex-attachment'
 ...
 * the lasmex-tools vocabulary into this schema and drift with it.
 */
