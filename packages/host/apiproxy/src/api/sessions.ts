...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from 'lasmex-attachment'
import type { ContentBlock } from 'lasmex-llm/types'
import type { SessionEvent, SessionId } from 'lasmex-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via lasmex-agent) must not enter client aggregates.
import type { SessionProjectionMap } from 'lasmex-session-projection/types'
