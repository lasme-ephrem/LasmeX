...
import type { ApprovalRequestId } from 'lasmex-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from 'lasmex-host-apiproxy/api'
import type { RpcId } from 'lasmex-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from 'lasmex-host-apiproxy/api/rpc'
