...
import { createUserMessage, MessageId } from 'lasmex-llm'
...
import {
  ...
  type StoredPrefix,
} from 'lasmex-session-persistence'
...
describe('Remote Agent and Session lookup policy', () => {
  it('deduplicates a cold resume across Agent and Session parameters', async () => {
    ...
    const resumedSession = { id: sessionId, header: meta, events: [] } as unknown as import('lasmex-session').Session
