...
import type { DirectoryPickerCapability } from 'lasmex-host-directory-picker'
import WorkspaceRegistry from 'lasmex-workspace'
import type { HostFrame, WorkspaceId } from 'lasmex-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from 'lasmex-host-apiproxy/api/rpc'
