...
- Shipped permission presets use localized product labels and impact descriptions in French, English, and Chinese; extension presets preserve host-provided copy. Command and Settings writes keep the machine name on the wire, and each warning body follows the active locale.
