...
| [development.md](development.md) | Contributor setup, daily workflow, and a summary of CI; a multilingual set under the [i18n contract](i18n/README.md) | Runtime/version rationale (→ Agent Notes), check-by-check lists that drift from `package.json` scripts |
