...
const DEPLOY_ROOT_PACKAGE = 'lasmex-jsonrpc-agent-pkg'
/** The closed-runtime app entry inside the deployed closure. */
const ENTRY_BIN = 'node_modules/lasmex-sdk-jsonrpc-demo/lib/packaged-bin.js'
const OUTPUT_BASENAME = 'lasmex-jsonrpc-agent-pkg'
...
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/lasmex_runtime/runtime'
