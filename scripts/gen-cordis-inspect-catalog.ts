...
import type { CordisCatalogModel, ServiceMethodEntry } from 'lasmex-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('lasmex-tool-cordis/api-catalog', 'lasmex-cordis-client-runner/client/api-catalog')
